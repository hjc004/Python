...
def add_info(stuOrTea_infos):
    ...
    try:
        ...
        assert new_sex == 'B' or new_sex == 'G', "填B或G"
    except Exception as rusult:
        print('ERROR:\n',result)
    # 提示并获取的手机号码
...
def add_score():
    ...
    try:
        ...
        assert new_score <=100 or new_score >=100, "成绩不正常"
    except Exception as rusult:
        print('ERROR:\n',result)
    score = {}
    score['num'] = new_num
